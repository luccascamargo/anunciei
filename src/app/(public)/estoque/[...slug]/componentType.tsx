                        ...
                        <CardHeader>
                          <div className=" w-full h-full flex items-center gap-3">
                            <Button
                              ...
                              onClick={() => router.push("/estoque/carros")}
                            >
                              Carros
                            </Button>
                            <Button
                              ...
                              disabled={slug === "motos"}
                              onClick={() => router.push("/estoque/motos")}
                            >
                              Motos
                            </Button>
                            <Button
                              variant={
                                slug === "caminhoes" ? "default" : "outline"
                              }
                              disabled={slug === "caminhoes"}
                              onClick={() => router.push("/estoque/caminhoes")}
                            >
                              Caminhões
                            </Button>
                          </div>
