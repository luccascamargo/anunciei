    ...
    <>
      <div className="container mx-auto pt-10 pb-20">
        <div className="flex items-end justify-between pt-10">
          <div className="flex flex-col gap-4">
            <span className="text-primary text-opacity-65 text-5xl font-bold uppercase">
              {advert.marca} {advert.ano_modelo}
            </span>
        ...
        <div className="mt-9 w-full flex items-start gap-8 justify-between">
          ...
          <Card className="h-auto sticky top-0">
            <CardHeader className="flex flex-row items-center justify-between p-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <HeartIcon className="cursor-pointer text-primary" />
              </div>
            </CardHeader>
        ...
        <div className="w-full flex justify-between p-6 border rounded-md shadow mt-10">
          <div className="flex flex-col gap-3">
            <span className="text-primary text-base font-semibold">Cidade</span>
            <p className="text-primary text-base font-medium text-opacity-65">
              {advert.cidade}
            </p>
          </div>
          <div className="flex flex-col gap-3">
            <span className="text-primary text-base font-semibold">Cor</span>
            <p className="text-primary text-base font-medium text-opacity-65">
              {advert.cor}
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            <span className="text-primary text-base font-semibold">Portas</span>
            <p className="text-primary text-base font-medium text-opacity-65">
              {advert.portas}
            </p>
          </div>
          <div className="flex flex-col gap-3">
            <span className="text-primary text-base font-semibold">Cambio</span>
            <p className="text-primary text-base font-medium text-opacity-65">
              {advert.cambio}
            </p>
          </div>
        ...
        <div className="flex flex-col gap-5 mt-10">
          ...
          <p className="text-primary text-base leading-7">{advert.descricao}</p>
        </div>
        <div className="bg-secondary shadow rounded-md mt-10 p-6 flex items-center justify-between">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-5">
              <Avatar className="w-12 h-12">
                <AvatarImage src={advert.usuario.imagem!} />
        ...
        <div className="mt-10 flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-2 h-auto max-w-[500px] flex-wrap ">
            {advert.opcionais.length === 0 && (
              <span className="text-primary">Nenhum opcional cadastrado</span>
            )}
